    ...
    phases: [
      {
        ...
        element: 'fire',
        level: 22,
        stats: { hp: 196, atk: 42, def: 25, spd: 22 },
        moveKeys: ['magma_breath', 'flame_wall'],
      ...
      },
      {
        ...
        element: 'shadow',
        level: 26,
        stats: { hp: 140, atk: 56, def: 17, spd: 31 },
    ...
    phases: [
      {
        ...
        element: 'ice',
        level: 28,
        stats: { hp: 168, atk: 36, def: 34, spd: 31 },
        moveKeys: ['frost_bite', 'blizzard'],
      ...
      },
      {
        ...
        element: 'void',
        level: 32,
        stats: { hp: 120, atk: 52, def: 24, spd: 44 },
    ...
    phases: [
      {
        ...
        element: 'storm',
        level: 35,
        stats: { hp: 140, atk: 48, def: 20, spd: 42 },
        moveKeys: ['lightning_strike', 'thunder_clap'],
        spriteFilter: 'saturate(2.5) hue-rotate(30deg) contrast(1.4)',
      },
      {
      ...
      },
      {
        ...
        element: 'void',
        level: 40,
        stats: { hp: 100, atk: 65, def: 12, spd: 56 },
