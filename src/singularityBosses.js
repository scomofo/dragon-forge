...
export const SINGULARITY_BOSSES = [
  {
    ...
    baseXP: 100,
    scrapsReward: 200,
    idleSprite: assetUrl('/assets/npc/data_corruption_boss.png'),
    attackSprite: assetUrl('/assets/npc/data_corruption_boss_attack.png'),
    bespokeArt: true,
  ...
  },
  {
    ...
    baseXP: 150,
    scrapsReward: 300,
    idleSprite: assetUrl('/assets/npc/memory_leak_boss.png'),
    attackSprite: assetUrl('/assets/npc/memory_leak_boss_attack.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
    arenaFilter: 'grayscale(0.5) hue-rotate(330deg) contrast(1.3)',
    spriteFilter: null,
  ...
  },
  {
    ...
    baseXP: 200,
    scrapsReward: 400,
    idleSprite: assetUrl('/assets/npc/stack_overflow_boss.png'),
    attackSprite: assetUrl('/assets/npc/stack_overflow_boss_attack.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
    arenaFilter: 'grayscale(0.5) hue-rotate(330deg) contrast(1.3)',
    spriteFilter: null,
...
export const FINAL_BOSS = {
  ...
  idleSprite: assetUrl('/assets/npc/singularity_ignition_boss.png'),
  attackSprite: assetUrl('/assets/npc/singularity_ignition_boss_attack.png'),
  bespokeArt: true,
  phases: [
    {
    ...
    },
    {
      ...
      moveKeys: ['lightning_strike', 'thunder_clap'],
      idleSprite: assetUrl('/assets/npc/singularity_surge_boss.png'),
      attackSprite: assetUrl('/assets/npc/singularity_surge_boss_attack.png'),
      spriteFilter: null,
    },
    {
      ...
      idleSprite: assetUrl('/assets/npc/singularity_void_boss.png'),
      attackSprite: assetUrl('/assets/npc/singularity_void_boss_attack.png'),
      spriteFilter: null,
    },
  ],
};
...
export const MIRROR_ADMIN = {
  ...
  idleSprite: assetUrl('/assets/npc/mirror_admin_protocol.png'),
  attackSprite: assetUrl('/assets/npc/mirror_admin_protocol_attack.png'),
  bespokeArt: true,
  phases: [
    {
    ...
    },
    {
      ...
      moveKeys: ['void_rift', 'null_reflect'],
      idleSprite: assetUrl('/assets/npc/mirror_admin_warden.png'),
      attackSprite: assetUrl('/assets/npc/mirror_admin_warden_attack.png'),
      spriteFilter: null,
    },
    {
      ...
      idleSprite: assetUrl('/assets/npc/mirror_admin_reset.png'),
      attackSprite: assetUrl('/assets/npc/mirror_admin_reset_attack.png'),
      spriteFilter: null,
    },
  ],
...
export const CORRUPTION_REMNANTS = [
  {
    ...
    baseXP: 300,
    scrapsReward: 600,
    idleSprite: assetUrl('/assets/npc/remnant_data_corruption.png'),
    attackSprite: assetUrl('/assets/npc/remnant_data_corruption_attack.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
  ...
  },
  {
    ...
    baseXP: 420,
    scrapsReward: 840,
    idleSprite: assetUrl('/assets/npc/remnant_memory_leak.png'),
    attackSprite: assetUrl('/assets/npc/remnant_memory_leak_attack.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
    arenaFilter: 'grayscale(0.3) hue-rotate(330deg) contrast(1.5) saturate(1.5)',
  ...
  },
  {
    ...
    baseXP: 560,
    scrapsReward: 1120,
    idleSprite: assetUrl('/assets/npc/remnant_stack_overflow.png'),
    attackSprite: assetUrl('/assets/npc/remnant_stack_overflow_attack.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
    arenaFilter: 'grayscale(0.3) hue-rotate(330deg) contrast(1.5) saturate(1.5)',
