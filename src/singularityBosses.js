...
export const SINGULARITY_BOSSES = [
  {
    ...
    attackSprite: assetUrl('/assets/npc/data_corruption_boss.png'),
    bespokeArt: true,
  ...
  },
  {
    ...
    attackSprite: assetUrl('/assets/npc/memory_leak_boss.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
    arenaFilter: 'grayscale(0.5) hue-rotate(330deg) contrast(1.3)',
    spriteFilter: null,
  ...
  },
  {
    ...
    attackSprite: assetUrl('/assets/npc/stack_overflow_boss.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
    arenaFilter: 'grayscale(0.5) hue-rotate(330deg) contrast(1.3)',
    spriteFilter: null,
...
export const FINAL_BOSS = {
  ...
  attackSprite: assetUrl('/assets/npc/singularity_ignition_boss.png'),
  bespokeArt: true,
  phases: [
    {
    ...
    },
    {
      ...
      attackSprite: assetUrl('/assets/npc/singularity_surge_boss.png'),
      spriteFilter: null,
    },
    {
      ...
      attackSprite: assetUrl('/assets/npc/singularity_void_boss.png'),
      spriteFilter: null,
    },
  ],
};
...
export const MIRROR_ADMIN = {
  ...
  attackSprite: assetUrl('/assets/npc/mirror_admin_protocol.png'),
  bespokeArt: true,
  phases: [
    {
    ...
    },
    {
      ...
      attackSprite: assetUrl('/assets/npc/mirror_admin_warden.png'),
      spriteFilter: null,
    },
    {
      ...
      attackSprite: assetUrl('/assets/npc/mirror_admin_reset.png'),
      spriteFilter: null,
    },
  ],
...
export const CORRUPTION_REMNANTS = [
  {
    ...
    attackSprite: assetUrl('/assets/npc/remnant_data_corruption.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
  ...
  },
  {
    ...
    attackSprite: assetUrl('/assets/npc/remnant_memory_leak.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
    arenaFilter: 'grayscale(0.3) hue-rotate(330deg) contrast(1.5) saturate(1.5)',
  ...
  },
  {
    ...
    attackSprite: assetUrl('/assets/npc/remnant_stack_overflow.png'),
    bespokeArt: true,
    arena: assetUrl('/assets/arenas/shadow.png'),
    arenaFilter: 'grayscale(0.3) hue-rotate(330deg) contrast(1.5) saturate(1.5)',
