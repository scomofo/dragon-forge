...
export const moves = {
  ...
  overclock:        { name: 'Overclock',      element: 'storm',  power: 50, accuracy: 100, vfxKey: 'OVERCLOCK',        canApplyStatus: true, applyChance: 1, isSignature: true },
  bastion:          { name: 'Bastion',        element: 'stone',  power: 0,  accuracy: 100, vfxKey: 'BASTION',          actionType: 'defendPlus', defBuff: 1.4, defDuration: 2, isSignature: true },
  hemotoxin:        { name: 'Hemotoxin',      element: 'venom',  power: 45, accuracy: 100, vfxKey: 'HEMOTOXIN',        canApplyStatus: true, applyChance: 1, isSignature: true },
  phase_strike:     { name: 'Phase Strike',   element: 'shadow', power: 55, accuracy: 100, vfxKey: 'PHASE_STRIKE',     ignoreDefend: true, canApplyStatus: false, isSignature: true },
  siphon_rift:      { name: 'Siphon Rift',    element: 'void',   power: 60, accuracy: 90,  vfxKey: 'SIPHON_RIFT',      lifesteal: 0.4, canApplyStatus: true, isSignature: true },
  restoration:      { name: 'Restoration',    element: 'light',  power: 0,  accuracy: 100, vfxKey: 'RESTORATION',      actionType: 'heal', healPercent: 0.25, cleanse: true, isSignature: true },
  recompile:        { name: 'Recompile',      element: 'synthesis', power: 70, accuracy: 90,  vfxKey: 'RECOMPILE',        copyAdvantage: true, canApplyStatus: true, isSignature: true },
  // NPC-only buff moves
