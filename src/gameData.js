...
export const npcs = {
  ...
  buffer_overflow: {
    ...
    baseXP: 30,
    scrapsReward: 40,
    idleSprite: assetUrl('/assets/npc/buffer_overflow_sprites.jpeg'),
    attackSprite: assetUrl('/assets/npc/buffer_overflow_attack.jpeg'),
  ...
  crypto_crab: {
    ...
    baseXP: 45,
    scrapsReward: 60,
    idleSprite: assetUrl('/assets/npc/crypto_crab_sprites.jpeg'),
    attackSprite: assetUrl('/assets/npc/crypto_crab_attack.jpeg'),
