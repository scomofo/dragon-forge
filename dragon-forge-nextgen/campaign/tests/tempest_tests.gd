...
func run() -> void:
	...
	check(migrated.version==11 and migrated.evolutions.storm=="" and not migrated.venom_culture_recovered and not migrated.venom_forged,"schema4 does not auto-evolve Arc or grant Venom progress")
