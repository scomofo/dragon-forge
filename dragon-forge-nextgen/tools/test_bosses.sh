...
for script in tests/run.gd tests/art_test.gd validation/review_tests.gd validation/polish_tests.gd campaign/tests/run.gd campaign/tests/party_tests.gd campaign/tests/evolution_tests.gd campaign/tests/fusion_tests.gd campaign/tests/tempest_tests.gd campaign/tests/audio_tests.gd campaign/tests/stone_tests.gd campaign/tests/venom_tests.gd campaign/tests/venom_runtime_tests.gd campaign/tests/shadow_tests.gd campaign/tests/shadow_runtime_tests.gd campaign/tests/trial_tests.gd campaign/tests/boss_tests.gd campaign/tests/play_smoke.gd campaign/tests/fusion_play.gd campaign/tests/boss_play.gd; do
