...
def main() -> None:
    ...
    if len(assets)!=63: raise SystemExit('Expected 29 models, 24 maps and 10 recordings; review inventory before changing this gate.')
    ...
    for target,(preset,name) in TARGETS.items():
        ...
        (folder/'README-FIRST.txt').write_text(
            'DRAGON FORGE - RECONNECTION / VENOM RESONANCE\n'
