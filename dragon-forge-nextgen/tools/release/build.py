...
def main() -> None:
    ...
    if len(assets)!=73: raise SystemExit('Expected 31 models, 32 maps and 10 recordings; review inventory before changing this gate.')
    ...
    for target,(preset,name) in TARGETS.items():
        ...
        (folder/'README-FIRST.txt').write_text(
            'DRAGON FORGE - RECONNECTION / VOID RESONANCE\n'
