...
@export var actor_sets: Array = []
@export var global_clips: Array = []
@export var reduced_motion_profile_id: StringName
@export var fallback_policy: StringName = &"content_lock_error"
@export var notes: String = ""


func find_actor_set(actor_set_id: StringName) -> Resource:
...
func find_clip(clip_id: StringName) -> Resource:
